...
class Escort_Hybrid_Map(models.Model):
    ...
    opponent_defence_tank = models.CharField(max_length=100)
    opponent_defence_dps_1 = models.CharField(max_length=100)
    opponent_defence_dps_2 = models.CharField(max_length=100)
    opponent_defence_support_1 = models.CharField(max_length=100)
    opponent_defence_support_2 = models.CharField(max_length=100)
    mount_defence_tank = models.CharField(max_length=100)
    mount_defence_dps_1 = models.CharField(max_length=100)
    mount_defence_dps_2 = models.CharField(max_length=100)
    mount_defence_support_1 = models.CharField(max_length=100)
    mount_defence_support_2 = models.CharField(max_length=100)
